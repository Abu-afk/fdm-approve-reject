...
export const createClaim = (data: { currency?: string; employeeComment?: string }) =>
  api.post('/claims', data);
export const getClaim = (claimId: string) => api.get(`/claims/${claimId}`);
...
// Manager
export const getManagerPendingClaims = () => api.get('/manager/claims');
...
// Finance
export const getFinanceApprovedClaims = () => api.get('/finance/claims');
